...
The goal of `{argh}` is to (try) to provide advices on obscure R error messages. 

## Disclaimer and notes 

+ The messages returned by `{argh}` try to explain what the error is. There is no guarantee they succeed. 

+ So far, there are `r nrow(read.csv("inst/en_errors.csv"))` errors analysed __for english__.

+ So far it only works with English. But feel free to contribute with your translation of [inst/en_errors.csv](inst/en_errors.csv).
